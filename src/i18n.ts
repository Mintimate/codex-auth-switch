...
const zhCN = {
  ...
  oauthNameHint: "名称只用于本机账号列表，不会发送给账号服务。",
  oauthGuideEyebrow: "OAuth 登录链路",
  oauthGuideTitle: "新账号如何登录",
  oauthGuideDescription: "授权结果写入当前 CODEX_HOME，不经过中转服务。",
  oauthGuidePairingTitle: "配对信息",
  oauthGuidePairingDescription: "浏览器地址与一次性验证码",
  oauthGuideGenerateConnector: "继续后生成",
  oauthGuideAuthorizeTitle: "浏览器授权",
  oauthGuideAuthorizeDescription: "本机打开，或由账号持有人完成",
  oauthGuideAuthorizeConnector: "授权完成",
  oauthGuideAuthFileDescription: "写入当前 CODEX_HOME",
  oauthGuideEffectiveConnector: "下次请求生效",
  oauthGuideSharedTitle: "Codex CLI 与 Codex",
  oauthGuideSharedDescription: "共享同一登录状态",
  oauthSharedStateNote:
    "在同一个 CODEX_HOME 下，Codex CLI 与 Codex 读取同一份 auth.json，因此会共享当前登录态。",
  oauthGuideNote: "整个过程不会导出或分享本设备已有账号的登录凭据。",
  continue: "继续",
  workAccount: "工作账号",
...
const en: Messages = {
  ...
  oauthNameHint:
    "This name is used only in the local account list and is never sent to the account service.",
  oauthGuideEyebrow: "OAuth login path",
  oauthGuideTitle: "How the new account signs in",
  oauthGuideDescription:
    "Authorization is written to the current CODEX_HOME without a relay service.",
  oauthGuidePairingTitle: "Pairing details",
  oauthGuidePairingDescription: "Browser URL and one-time verification code",
  oauthGuideGenerateConnector: "Generated next",
  oauthGuideAuthorizeTitle: "Browser authorization",
  oauthGuideAuthorizeDescription:
    "Open locally or let the account owner complete it",
  oauthGuideAuthorizeConnector: "Authorized",
  oauthGuideAuthFileDescription: "Written to the current CODEX_HOME",
  oauthGuideEffectiveConnector: "Next request",
  oauthGuideSharedTitle: "Codex CLI and Codex",
  oauthGuideSharedDescription: "Share the same login state",
  oauthSharedStateNote:
    "When they use the same CODEX_HOME, Codex CLI and Codex read the same auth.json and therefore share the current login state.",
  oauthGuideNote:
    "This process never exports or shares credentials from accounts already stored on this device.",
  continue: "Continue",
