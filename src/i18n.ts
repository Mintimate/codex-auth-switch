...
const zhCN = {
  ...
  shareDescription: "在另一台设备打开本应用，扫描此二维码或导入剪贴板内容。",
  ...
  importDescription: "导入成功后会保存该账号，并立即切换为当前 Codex 登录。",
  ...
  importWarning:
    "只导入来自可信来源的内容。分享载荷会在 Rust 后端校验，原始令牌不会显示在界面或写入日志。",
  deviceCodeLogin: "Device Code 登录",
  ...
  verificationCodeCopyFailed: "无法复制验证码，请手动输入",
  waitingBrowser: "正在等待浏览器授权",
  deviceLoginHint:
    "如果页面提示不可用，请先在 ChatGPT 安全设置中启用 Device Code 登录；工作区账号可能需要管理员启用。",
  ...
  deviceLoginNextStep: "下一步会生成一次性验证码，并打开 OpenAI 登录页面。",
  continue: "继续",
  workAccount: "工作账号",
  ...
  loginCodeReady: "验证码已生成；如浏览器未自动打开，请点击“打开登录页面”",
...
const en: Messages = {
  ...
  authSharing: "Auth sharing",
  shareAccountTitle: "Share “{label}”",
  shareDescription:
    "Open this app on another device, then scan the QR code or import the clipboard contents.",
  ...
  shareWarning:
    "Compact encoding is not encryption. The QR code and clipboard contents still contain login credentials. Share them only with devices you trust, and do not keep screenshots or send them through messaging apps.",
  ...
  importDescription:
    "A successful import saves the account and immediately switches the current Codex login.",
  ...
  importWarning:
    "Only import content from a trusted source. The Rust backend validates the payload, and raw tokens are never displayed or written to logs.",
  deviceCodeLogin: "Device Code login",
  completeLoginInBrowser: "Complete login in your browser",
  deviceLoginDescription:
    "Enter the code below and authorize “Codex”. This window will save and switch to the new account when you finish.",
  copyVerificationCode: "Copy verification code",
  verificationCodeCopied: "Verification code copied",
  verificationCodeCopyFailed: "Could not copy the code. Enter it manually.",
  waitingBrowser: "Waiting for browser authorization",
  deviceLoginHint:
    "If the page says this feature is unavailable, enable Device Code login in ChatGPT security settings first. Workspace accounts may require administrator approval.",
  browserOpenFailed:
  ...
  loginCodeReady:
    "The code is ready. If the browser did not open automatically, select “Open login page”.",
