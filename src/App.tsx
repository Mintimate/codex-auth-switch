      ...
      <DialogPresence open={Boolean(deviceLogin)}>
        {deviceLogin ? (
          ...
          >
            ...
            <span className="device-code-hint">
              {t("deviceCodeClickToCopy")}
            </span>
      ...
      >
        {dialog ? (
          <form
            ...
            onMouseDown={(event) => event.stopPropagation()}
          >
            {dialog === "login" && <LoginFlow t={t} />}
            <div className={dialog === "login" ? "login-form-pane" : undefined}>
              ...
              <div className="dialog-actions">
                ...
                <button
                  type="submit"
                  className={`button primary${
                    dialog === "login" ? " oauth-launch-button" : ""
                  }`}
